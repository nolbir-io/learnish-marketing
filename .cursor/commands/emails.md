...
2. Read and follow `.agents/skills/emails/SKILL.md` for this request.

**Group:** Content & Copy

**Cross-references** (use if the task spills into their domain): `/copywriting`, `/copy-editing`, `/cold-email`, `/social`, `/video`, `/image`, `/sms`

Treat any text I type after `/emails` as the specific scope/request for this workflow. If I didn't add anything, ask me what to focus on before proceeding.
