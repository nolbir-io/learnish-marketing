...
2. Read and follow `.agents/skills/churn-prevention/SKILL.md` for this request.

**Group:** Growth & Retention

**Cross-references** (use if the task spills into their domain): `/referrals`, `/free-tools`, `/community-marketing`, `/lead-magnets`, `/co-marketing`

Treat any text I type after `/churn-prevention` as the specific scope/request for this workflow. If I didn't add anything, ask me what to focus on before proceeding.
