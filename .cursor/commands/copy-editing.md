...
2. Read and follow `.agents/skills/copy-editing/SKILL.md` for this request.

**Group:** Content & Copy

**Cross-references** (use if the task spills into their domain): `/copywriting`, `/cold-email`, `/emails`, `/social`, `/video`, `/image`, `/sms`

Treat any text I type after `/copy-editing` as the specific scope/request for this workflow. If I didn't add anything, ask me what to focus on before proceeding.
